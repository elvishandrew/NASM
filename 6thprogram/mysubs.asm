...
global writeString, string_to_int, readString, newLine, readList, print_list, intToString, greatest, average, least, readStringList, printString_list
...
;check if input is x
	...
	mov eax, [input]
	mov [edi], eax ;put it out at array address
	;mov [edi], byte 0 ;make it a null terminated string
